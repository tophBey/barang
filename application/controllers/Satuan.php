...
class Satuan extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($insert) {
                set_pesan("satuan",'data berhasil disimpan');
                redirect('satuan');
            } else {
                set_pesan("satuan",'data gagal disimpan', false);
                redirect('satuan/add');
            }
        }
    }
    ...
    public function delete($getId)
    {
        ...
        if ($this->admin->delete('satuan', 'id_satuan', $id)) {
            set_pesan("satuan",'data berhasil dihapus.');
        } else {
            set_pesan("satuan",'data gagal dihapus.', false);
        }
        redirect('satuan');
    }
}
